...
def load_assets():
    ...
    # --------- sons --------------
    assets['corona_on_sound'] = pygame.mixer.Sound('resources/music/coronaon.wav')
    assets['lost_sound'] = pygame.mixer.Sound('resources/music/lost1.wav')
    assets['menu_sound'] = pygame.mixer.Sound('resources/music/menu.wav')
    assets['explosion_sound'] = pygame.mixer.Sound('resources/music/explosion.wav')
    assets['laser1_sound'] = pygame.mixer.Sound('resources/music/laser1.wav')
    assets['laser2_sound'] = pygame.mixer.Sound('resources/music/laser2.wav')
    assets['powerup_sound'] = pygame.mixer.Sound('resources/music/powerup.wav')
